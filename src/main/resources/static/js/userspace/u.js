...
$(function() {
	...
	function getBlogsByName(pageIndex, pageSize,catalogId) {
		 $.ajax({ 
	...
	$.tbpage("#mainContainer", function (pageIndex, pageSize) {
		getBlogsByName(pageIndex, pageSize,null);
		_pageSize = pageSize;
	});
   
	// 关键字搜索
	$("#searchBlogs").click(function() {
		getBlogsByName(0, _pageSize,null);
	});
	...
	$(".blog-content-container").on("click",".blog-query-by-catalog", function () {
		...
		getBlogsByName(0, _pageSize,catalogId);
	});
